...
urlpatterns = [
    ...
    path('editcategory/<int:category_id>',views.cycloneadmin_editcategory.as_view(),name = 'editcategory'),
    ...
    path('discontinueproduct/',views.cycloneadmin_discontinuproduct.as_view(),name="discontinueproduct"),
